...
public class JmsConfiguration {
    ...
    public MessageConverter jaxbMarshaller() {
        ...
        jaxb2Marshaller.setPackagesToScan("soa.group5.emergency.integrations");
        jaxb2Marshaller.setSchemas(
            resourceLoader.getResource("classpath:xsd/Dispatch.xsd"),
            resourceLoader.getResource("classpath:xsd/Emergency.xsd")
        );
